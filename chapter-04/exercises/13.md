**Q**: How can you set only one of the two time values with the `utimes`
function?

---

**A**: Using `utimes` you will **ALWAYS** change the modification time and the
access time. There is no way to use something like `UTIME_OMIT` for preserving
the old values. You can use `stat` to retrieve `atim` and `mtim`, but `utimes`
only provides microseconds precision. We can see this by running the following
program:
...
```bash
=== Before utimensat ===
Modification time: 2026-05-07 17:01:36.643510203 -0300
      Access time: 2026-05-07 17:01:37.315578666 -0300
      Change time: 2026-05-07 17:01:36.648582631 -0300
=== After utimensat ===
Modification time: 2026-05-07 17:01:36.643510203 -0300
      Access time: 2026-05-07 17:01:37.315578666 -0300
      Change time: 2026-05-07 17:01:36.648582631 -0300
=== After utimes ===
Modification time: 2026-05-07 17:01:36.643510000 -0300
      Access time: 2026-05-07 17:01:37.315578000 -0300
      Change time: 2026-05-07 17:01:42.015550798 -0300
```
